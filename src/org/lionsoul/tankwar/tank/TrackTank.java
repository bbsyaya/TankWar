...
/**
 * Track tank class .<br />
 * feature: it will always track your step, and move towards you and try to kill
 * you . <br />
 */
public class TrackTank extends Tank {
	// TrackTankÀà£¬»á¸ú×Ù×·É±Ó¢ÐÛÌ¹¿Ë

	// the aim tank
	private Tank aimTank;

	public TrackTank(Battlefield bf, Image[] images, int t, int serial, int x,
