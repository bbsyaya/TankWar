...
/**
 * Wich(no special meaning) tank class . feature: its action is totally like
 * random tank before you scare it but when you close it enough it will follow
 * you all the time and shot you crazily (^.^)
 */
public class WichTank extends RandomTank {

	// WichTank类。当英雄坦克远离它时，它将做随机运动；靠近时，将会追杀英雄坦克
	...
	public WichTank(Battlefield bf, Image[] images, int t, int serial, int x,
	...
	public void draw(Graphics g) {
		...
		/*
		 * the hero tank has scared the wich.(in its scared circle) And of
		 * course, wich will shot it crazy, and you will find yourself
