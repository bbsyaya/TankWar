...
public class Battlefield extends JFrame {
	...
	public Battlefield() {
		...
		setIconImage(new ImageIcon(
				Battlefield.class.getResource("/res/image/3.png")).getImage());

		// add the battle canvas
	...
	public void loadResource() {
		...
		background = new Image[] { bg.getImage(),
		...
		enemyImages = new Image[][] {
				new Image[] {
						ImageLoader.loadImageIcon("tank/enemy/1/tank-u.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-ru.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-r.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-rd.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-d.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-ld.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-l.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/1/tank-lu.png")
								.getImage() },
				new Image[] {
						ImageLoader.loadImageIcon("tank/enemy/2/tank-u.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-ru.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-r.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-rd.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-d.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-ld.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-l.png")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/2/tank-lu.png")
								.getImage() },
				new Image[] {
						ImageLoader.loadImageIcon("tank/enemy/3/tank-u.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-ru.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-r.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-rd.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-d.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-ld.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-l.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/3/tank-lu.gif")
								.getImage() },
				new Image[] {
						ImageLoader.loadImageIcon("tank/enemy/4/tank-u.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-ru.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-r.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-rd.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-d.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-ld.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-l.gif")
								.getImage(),
						ImageLoader.loadImageIcon("tank/enemy/4/tank-lu.gif")
								.getImage() } };
		...
		explosionImages = new Image[][] {
				...
				new Image[] {
						ImageLoader.loadImageIcon("explosion/big/1.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/2.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/3.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/4.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/5.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/6.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/7.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/8.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/9.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/10.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/11.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/12.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/13.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/14.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/15.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/16.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/17.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/18.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/19.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/20.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/21.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/22.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/23.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/24.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/25.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/26.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/27.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/28.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/29.png")
								.getImage(),
						ImageLoader.loadImageIcon("explosion/big/30.png")
								.getImage() } };
		...
		// shot audio
		/*
		 * shotClip = new AudioClip[] { AudioLoader.loadAudio("shot.wav") };
		 */
		...
		// user interface
		bselector = new BarriersSelector(this, 1, barriersSetting.length, 60,
				w_size.width, w_size.height, new ImageIcon[] {
		...
		tankmap = new TMap(w_size.height / height, w_size.width / width, width,
				height, null);
	 ...
	 * 2. create the battlefield components with the given barriers index . <br />
	...
	private void create(Barriers barrier) {
		...
		TankFactory.reset();
		hero = TankFactory.createCenterHeroTank(this, width, height,
				barrier.getHeroArgs());
		tanks.put(hero.getSerial(), hero);

		// enemy tank
		width = IConstants.T_WIDTH;
		height = IConstants.T_WIDTH;
		int tanknum = TankFactory.DEFAULT_TANK_OUTPUT - 1;
		if (barrier.getEnemyNumber() < tanknum)
			tanknum = barrier.getEnemyNumber();
		Tank etank;
		int type;
		for (int j = 0; j < tanknum; j++) {
			/*
			 * make it here for now, Acturly we need a good alrigthm for the
			 * generate of enemy tanks
			 */
			type = ((int) (Math.random() * 1000))
					% TankFactory.ENEMY_TANK_TYPE_NUMBER;
		...
		// set the walls
		tankmap.setWalls(RandomWordsMap.generate(wallImages,
				8,
				8,
				tankmap.getCols() - 2 * hero.getCols(), // left some space for
														// the round
				tankmap.getRows() - 2 * hero.getRows(), hero.getCols(),
				hero.getRows()));
	...
	/**
	 * start the game by start a counting thread . <br />
	 */
	private void start() {
		new Thread(new Runnable() {
			...
			public void run() {
				while (true) {
					...
					switch (state) {
					case GAME_BARRIER_SELECT:
						bselector.draw(bufferScreen);
						break;
					...
					if (gameHelp.isVisible())
						bufferScreen.drawImage(gameHelp.getHelpImage(),
								...
								(w_size.height - gameHelp.getHeight()) / 2,
								null);
	...
	public GameResult createGR(int ret) {
		ImageIcon icon = (ret == GAME_SUCCEED) ? ImageLoader
				.loadImageIcon("barriers/grass.gif") : ImageLoader
				.loadImageIcon("barriers/sand.gif");
	...
	public void runningDraw() {
		...
		while (eit.hasNext()) {
			...
			if (!etank.isAlive()) {
				...
				etank.draw(bufferScreen);
		}

		// check the mask to add new tank
		if (_new) {
			if (TankFactory.getTankOutput() < barriersSetting[bselector
					.getBarriers() - 1].getEnemyNumber()) {
				etank = TankFactory.createEnemyTank(this, IConstants.T_WIDTH,
						IConstants.T_WIDTH, barriersSetting[bselector
								.getBarriers() - 1].getEnemyArgs(),
		...
		/*
		 * bullets we should put the code in a synchronized block cause the
		 * bullets of the hero tank will be added from the EDT thread
		 */
	...
	private void drawGameInfo(Graphics g) {
		String str = (mode < 0 ? "Standard" : "Simple")
				+ " mode, Enemy:"
				+ (barriersSetting[bselector.getBarriers() - 1]
						.getEnemyNumber()
						- TankFactory.getTankOutput()
						+ tanks.size() - 1) + ", Press h for Help";
		g.setFont(IConstants.iFont);
		g.setColor(IConstants.iColor);
		g.drawString(str, w_size.width - g.getFontMetrics().stringWidth(str)
				- 10, w_size.height - IConstants.iFont.getSize());
	}
	...
	public void addSynBullet(final Bullet e) {
		...
		/*
		 * if ( isSoundOpen() ) { tpool.execute(new Runnable() {
		 * 
		 * @Override public void run() { shotClip[0].stop(); shotClip[0].play();
		 * } }); }
		 */
	}
	...
	public void setBarriers(int barriers) {
		if (barriers < barriersSetting.length)
